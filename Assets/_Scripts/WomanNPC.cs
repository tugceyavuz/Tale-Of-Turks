...
public class WomanNPC : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        string openingPromptFilePath = Path.Combine(Application.streamingAssetsPath, "WomanNPC.txt");
        ...
        if (quitButton != null)
        {
            quitButton.onClick.AddListener(EndInteraction);
        }
    }
    ...
    public void EndInteraction()
    {
        ...
        zeroText();
        dialoguePanel.SetActive(false);
        playerInputField.gameObject.SetActive(false); // Hide input field
        interactionMessage.text = "Interaction ended"; // Show a message indicating the end of interaction
    }
