...
public class ManNPC : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        string openingPromptFilePath = Path.Combine(Application.streamingAssetsPath, "manNPC.txt");
    ...
    void Update()
    {
        ...
        if (Input.GetKeyUp(KeyCode.Return) && playerInputField.isFocused && this.CompareTag("ManNPC"))
        {
    ...
    {
        if (other.CompareTag("Player") && this.CompareTag("ManNPC"))
        {
            playerClose = true;
        }
    }
